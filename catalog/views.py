...
class LoanedBooksAllUsersListView(LoginRequiredMixin, generic.ListView):
    """Generic class-based view listing books on loan to all users."""
    model = BookInstance
    template_name = 'catalog/borrowed_books_list_allusers.html'
    paginate_by = 10
